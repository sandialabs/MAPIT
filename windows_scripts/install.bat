...
::----------------------------------------------
:: Having found the path, create a new conda
:: environment using the requriements.yml
:: Also includes some catches in case a user
:: tries to run this again while the requirements
:: and default environment are already installed
::----------------------------------------------
